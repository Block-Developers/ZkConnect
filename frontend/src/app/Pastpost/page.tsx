    ...
    async function fetchData() {
      ...
      try {
        const response = await fetch(
          "https://zk-backend.vercel.app/jobPosts/my-posts",
          {
            headers: {
              Authorization: token,
            },
