  ...
  return (
    <div className="hero2">
      ...
      <div className="pt-[150px] pb-[100px] px-[100px]">
        ...
        <div className="block rounded-xl text-white bg-[#202020] dark:bg-dark-700 p-6 cursor-pointer border border-white border-[4px] hover:border-light-400 hover:dark:border-dark-100 w-full">
