...
export default function UserProfile() {
  return (
    <section className="hero2 pb-[150px]">
      <div>
        <MainNav />
      </div>
      <div className="h-screen w-screen">
        ...
        <div className="md:py-[70px] md:px-[80px] py-[30px] px-[30px] text-white font-agrandir ">
          ...
          <h4 className="text-[18px] font-medium leading-6 py-1">@prashant7</h4>
          ...
          <h4 className="text-[20px] font-bold leading-9 py-6">Top Skills</h4>
          ...
          <div className="flex md:gap-5 gap-2  py-5">
            <div className="flex flex-col">
              <h1 className="md:text-[20px] text-sm font-agrandir md:font-semibold font-bold">
                Github Contribution
              </h1>
              <h1 className="text-[20px] font-agrandir font-semibold">678</h1>
            </div>
            <div className="flex flex-col">
              <h1 className="md:text-[20px] text-sm font-agrandir md:font-semibold font-bold">
                PR Contribution
              </h1>
              <h1 className="text-[20px] font-agrandir font-semibold">78</h1>
            </div>
          </div>
